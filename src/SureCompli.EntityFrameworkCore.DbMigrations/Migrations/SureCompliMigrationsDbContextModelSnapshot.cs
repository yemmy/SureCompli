...
{
    [DbContext(typeof(SureCompliMigrationsDbContext))]
    partial class SureCompliMigrationsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SureCompli.SureCompli.BlockChain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AppBlockChains");
                });

            modelBuilder.Entity("SureCompli.SureCompli.BlockChainNode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppBlockChainNodes");
                });

            modelBuilder.Entity("SureCompli.SureCompli.Country", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SureCompli.SureCompli.Engagement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ContractTransactionDump")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AppEngagements");
                });

            modelBuilder.Entity("SureCompli.SureCompli.EngagementCharge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ChargeReceiverId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppEngagementCharges");
                });

            modelBuilder.Entity("SureCompli.SureCompli.EngagementQA", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppEngagementQAs");
                });

            modelBuilder.Entity("SureCompli.SureCompli.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SureCompli.SureCompli.Regulation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppRegulations");
                });

            modelBuilder.Entity("SureCompli.SureCompli.RegulationCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppRegulationCategories");
                });

            modelBuilder.Entity("SureCompli.SureCompli.RegulationQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppRegulationQuestions");
                });

            modelBuilder.Entity("SureCompli.SureCompli.UserKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SureCompli.Users.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SureCompli.SureCompli.BlockChainNode", b =>
                {
                    b.HasOne("SureCompli.SureCompli.BlockChain", "BlockChain")
                        .WithMany("BlockChainNodes")
                        .HasForeignKey("BlockChainId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SureCompli.Users.AppUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("SureCompli.SureCompli.Engagement", b =>
                {
                    b.HasOne("SureCompli.Users.AppUser", null)
                        .WithMany("Engagements")
                        .HasForeignKey("AppUserId");

                    b.HasOne("SureCompli.SureCompli.Regulation", "Regulation")
                        .WithMany()
            ...
            modelBuilder.Entity("SureCompli.SureCompli.EngagementCharge", b =>
                {
                    b.HasOne("SureCompli.SureCompli.Engagement", "Engagement")
                        .WithMany("EngagementCharges")
            ...
            modelBuilder.Entity("SureCompli.SureCompli.EngagementQA", b =>
                {
                    b.HasOne("SureCompli.Users.AppUser", "Answerer")
                        .WithMany()
                    ...
                    b.HasOne("SureCompli.SureCompli.Engagement", "Engagement")
                        .WithMany("EngagementQA")
                        .HasForeignKey("EngagementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SureCompli.SureCompli.Question", "Question")
                        .WithMany()
            ...
            modelBuilder.Entity("SureCompli.SureCompli.Regulation", b =>
                {
                    b.HasOne("SureCompli.SureCompli.RegulationCategory", "Category")
                        .WithMany("Regulations")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SureCompli.SureCompli.Country", "Country")
                        .WithMany("Regulations")
            ...
            modelBuilder.Entity("SureCompli.SureCompli.RegulationCategory", b =>
                {
                    ...
                    b.HasOne("SureCompli.SureCompli.RegulationCategory", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("SureCompli.SureCompli.UserKey", b =>
                {
                    b.HasOne("SureCompli.Users.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("SureCompli.SureCompli.Engagement", b =>
                {
                    b.Navigation("EngagementCharges");

                    b.Navigation("EngagementQA");
                });

            modelBuilder.Entity("SureCompli.SureCompli.Question", b =>
                {
                    b.Navigation("RegulationQuestions");
                });
