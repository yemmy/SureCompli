...
namespace SureCompli.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BCType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    SecureInfo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBlockChains", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwerType = table.Column<int>(type: "int", nullable: false),
                    OwnerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    OptionsCSV = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRegulationCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppRegulationCategories_AppCountries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "AppCountries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppRegulationCategories_AppRegulationCategories_ParentId",
                        column: x => x.ParentId,
                        principalTable: "AppRegulationCategories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBlockChainNodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppBlockChainNodes_AppBlockChains_BlockChainId",
                        column: x => x.BlockChainId,
                        principalTable: "AppBlockChains",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppBlockChainNodes_AppUser_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedNodeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserKeys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserKeys_AppUser_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRegulations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppRegulations_AppCountries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "AppCountries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppRegulations_AppRegulationCategories_CategoryId",
                        ...
                        onUpdate: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AppRegulations_AppUser_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractTransactionDump = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEngagements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEngagements_AppRegulations_RegulationId",
                        column: x => x.RegulationId,
                        principalTable: "AppRegulations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppEngagements_AppUser_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRegulationQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppRegulationQuestions_AppQuestions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "AppQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppRegulationQuestions_AppRegulations_RegulationId",
                        column: x => x.RegulationId,
                        principalTable: "AppRegulations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEngagementCharges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEngagementCharges_AppEngagements_EngagementId",
                        column: x => x.EngagementId,
                        principalTable: "AppEngagements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "AppEngagementQAs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EngagementId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEngagementQAs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEngagementQAs_AppEngagements_EngagementId",
                        column: x => x.EngagementId,
                        principalTable: "AppEngagements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppEngagementQAs_AppQuestions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "AppQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppEngagementQAs_AppUser_AnswererId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppBlockChainNodes_BlockChainId",
                table: "AppBlockChainNodes",
                column: "BlockChainId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBlockChainNodes_OwnerId",
                table: "AppBlockChainNodes",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEngagementCharges_EngagementId",
                table: "AppEngagementCharges",
                column: "EngagementId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEngagementQAs_AnswererId",
                table: "AppEngagementQAs",
                column: "AnswererId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEngagementQAs_EngagementId",
                table: "AppEngagementQAs",
                column: "EngagementId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEngagementQAs_QuestionId",
                table: "AppEngagementQAs",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEngagements_AppUserId",
                table: "AppEngagements",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEngagements_RegulationId",
                table: "AppEngagements",
                column: "RegulationId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRegulationCategories_CountryId",
                table: "AppRegulationCategories",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRegulationCategories_ParentId",
                table: "AppRegulationCategories",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRegulationQuestions_QuestionId",
                table: "AppRegulationQuestions",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRegulationQuestions_RegulationId",
                table: "AppRegulationQuestions",
                column: "RegulationId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRegulations_CategoryId",
                table: "AppRegulations",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRegulations_CountryId",
                table: "AppRegulations",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRegulations_OwnerId",
                table: "AppRegulations",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserKeys_UserId",
                table: "AppUserKeys",
                column: "UserId");
